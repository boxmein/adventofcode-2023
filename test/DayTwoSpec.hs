...
spec = do 
  ...
  describe "minCubes" $ do 
    it "works on example data" $ do 
      minCubes (Game 1 [Grab 4 0 3, Grab 1 2 6, Grab 0 2 0]) `shouldBe` (4, 2, 6)
      minCubes (Game 2 [Grab 0 2 1, Grab 1 3 4, Grab 0 1 1]) `shouldBe` (1, 3, 4)

  describe "dayTwoPartTwo" $ do 
    it "works on example data" $ do 
      dayTwoPartTwo [
        "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green",
        "Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue",
